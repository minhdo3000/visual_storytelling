...
class TensorBoard:
    def __init__(self, opt):
        ...
        self.dir = os.path.join(opt.checkpoint_path, 'tensorboard', opt.id, opt.rnn_type)
...
class Logger:
    def __init__(self, opt):
        ...
        self.log_dir = os.path.join(opt.checkpoint_path, opt.id, opt.rnn_type)
        ...
        if opt.resume_from is not None:
            print(" resuming... ", str(os.path.join(opt.resume_from, 'infos.pkl')))
