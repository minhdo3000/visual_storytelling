...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--data_dir', type=str, default='/media/data3/minh/workspace/ce7455/b/data')
    ...
    parser.add_argument('--rnn_type', type=str, default='gru', help='gru, lstm, gru_att, bi_gru')
